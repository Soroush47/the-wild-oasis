...
import { FormData } from "./updatePasswordFormSchema";
import { useUpdateUser } from "./useUpdateUser";
import { useUser } from "./useUser";

function UpdatePasswordForm() {
    const { register, handleSubmit, errors, getValues, reset } = useUpdatePasswordForm();
    ...
    function onSubmit(data: FormData) {
        const { password } = data;
        updateUserMutation({ id, password }, { onSettled: () => reset() });
    }
